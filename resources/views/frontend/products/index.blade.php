...
@section('content')
	<div href="http://127.0.0.1:8000/products" class="breadcrumb-area pt-205 breadcrumb-padding pb-210" style="background-image: url({{ asset('themes/ezone/assets/img/bg/bg.jpeg') }})">
							...
							<div class="shop-bar pb-60">
								<div class="shop-found-selector">
									<div class="shop-found">
										<p><span>{{ count($products) }}</span> Produk yang kita temukan <span>{{ $products->total() }}</span></p>
									</div>
