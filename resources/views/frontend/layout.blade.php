...
<html class="no-js" lang="en">
    <head>
        ...
        <title>{{ config('ThinkThrift', 'ThinkThrift') }}</title>
                                    ...
                                    <li><a>kategori</a>
                                        <div class="category-menu-dropdown shop-menu">
                                            <div class="category-dropdown-style category-common2 mb-30">
                                                <h4 class="categories-subtitle"> kategori kita</h4>
                                                <ul>
                                                    <li><a href="http://127.0.0.1:8000/products?category=baju">Baju</a></li>
                                                    <li><a href="http://127.0.0.1:8000/products?category=sepatu">Sepatu</a></li>
                                                    <li><a href="http://127.0.0.1:8000/products?category=celana">Celana</a></li>
                                                    <li><a href="http://127.0.0.1:8000/products?category=jersey">Jersey</a></li>
                                                    <li><a href="http://127.0.0.1:8000/products?category=jaket">Jaket</a></li>
                                                </ul>
                                            </div>
                                           
                                            <div class="mega-banner-img">
                                                <a href="single-product.html">
                                                    <img src="{{ asset('themes/ezone/assets/img/banner/18.png') }}" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="mobile-menu">
                                <nav id="mobile-menu-active">
                                    <ul class="menu-overflow">
                                        <li><a href="#">HOME</a>
                                            <ul>
                                                <li><a href="http://127.0.0.1:8000/products">Shop</a></li>
                                                <li><a href="index-fashion-2.html">Kategori</a></li>
                                        ...
                                        <li><a href="#">shop</a>
                                            <ul>
                                                <li><a href="http://127.0.0.1:8000/products?category=baju">Baju</a></li>
                                                    <li><a href="http://127.0.0.1:8000/products?category=sepatu">Sepatu</a></li>
                                                    <li><a href="http://127.0.0.1:8000/products?category=baju">Celana</a></li>
                                                    <li><a href="http://127.0.0.1:8000/products?category=jersey">Jersey</a></li>
                                                    <li><a href="http://127.0.0.1:8000/products?category=jaket">Jaket</a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><a href="file:///C:/Users/LENOVO/Documents/property-1.0.0/property-1.0.0/index.html"> Contact  </a></li>
                                    </ul>
                                </nav>							
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="furniture-bottom-wrapper">
                        ...
                        <form action="{{ url('products') }}" method="GET">
                            <input placeholder="Saya mencari sesuatu . . ." type="text" name="q" value="{{ isset($q) ? $q : null }}">
                            <button>
                                <i class="ti-search"></i>
                            </button>
                        </form>
            ...
            <div class="container-fluid">
                <div class="services-wrapper">
                    ...
                    <div class="single-services mb-40">
                        ...
                        <div class="services-content">
                            <h4>Tersedia Semua Pembayaran</h4>
                            <p>Contrary to popular belief, Lorem Ipsum is random text. </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-info-wrapper-3">
                                ...
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>+62858766690907 <br>+62882005725119 </p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                    ...
                                    <div class="footer-info-content3">
                                        <p><a href="#"> thinkthrift@gmail.com</a> <br></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="copyright-furniture">
                                <p>Copyright © <a href="https://hastech.company/">ThinkThrift</a> 2024 . All Right Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
