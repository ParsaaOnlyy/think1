...
@section('content')
	<!-- header end -->
	<div class="breadcrumb-area pt-205 breadcrumb-padding pb-210" style="background-image: url({{ asset('themes/ezone/assets/img/bg/bg2.jpeg') }})">
		<div class="container">
						...
						<div class="row">
							<div class="col-md-5 ml-auto">
								<div class="cart-page-total">
									...
									<a href="https://wa.me/6285876690907">Proses ke Whatsapp</a>
								</div>
							</div>
						</div>
                        </form>
